...
- WSOP公式イベントは `$1,000 Tag Team` を最優先候補にする。
- `$1,000 Mystery Millions` はDay 2が帰国移動後の2026-06-28(日)になるため、勝ち残る前提では参加しない。
...
| 高 | WSOP本戦に何本出るか | 2026-05末 | 帰国便までに終わるイベントを優先 |
| 高 | 6/24 Tag Teamに出るか | 2026-05末 | 帰国便までに完結する有力候補 |
