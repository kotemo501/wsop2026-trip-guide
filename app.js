const tripDays = {
  "2026-06-22": { label: "6/22 Arrival", note: "Horseshoe導線、水、早寝。18:00-21:00 Welcome Party。", date: "6/22", dow: "Mon", nextDate: "Mon 6/22", nextTitle: "出発・到着", tag: "TRAVEL DAY", visual: "assets/generated-poker-journey-hero-desktop.png", visualLabel: "BASE", hand: "ラスベガス到着・移動日", time: "18:00-21:00 Welcome Party", seat: "Horseshoe / Ellis Island", stack: "パスポート、スマホ、カード、水、上着", fold: "無理をしない。寝不足でプレイしない。飲みすぎない。" },
  "2026-06-23": { label: "6/23 Daily", note: "13:00 Daily。会場と登録導線に慣れる。", date: "6/23", dow: "Tue", nextDate: "Tue 6/23", nextTitle: "$250 Daily", tag: "TOURNAMENT", visual: "assets/generated-poker-journey-hero-desktop.png", visualLabel: "WSOP", hand: "$250 Daily Deepstack", time: "13:00 start", seat: "WSOP会場", stack: "パスポート、現金/カード、上着、水", fold: "Tag Team前夜なので深追いしない。" },
  "2026-06-24": { label: "6/24 Tag Team", note: "10:00目安で会場。12:00開始。", date: "6/24", dow: "Wed", nextDate: "Wed 6/24", nextTitle: "Tag Team", tag: "EVENT #66", visual: "assets/generated-poker-journey-hero-desktop.png", visualLabel: "TEAM", hand: "Event #66 Tag Team", time: "10:00会場 / 12:00 start", seat: "WSOP会場", stack: "パスポート、支払い手段、スマホ、上着", fold: "登録をぎりぎりにしない。翌朝が早いので夜更かししない。" },
  ...
  "2026-06-26": { label: "6/26 Recovery", note: "疲労優先。買い物、散歩、ポーカーは体力で選ぶ。", date: "6/26", dow: "Fri", nextDate: "Fri 6/26", nextTitle: "回復日", tag: "FLEX", visual: "assets/generated-poker-felt-texture.png", visualLabel: "FREE", hand: "回復日 / フリー日", time: "固定時刻なし", seat: "近場中心", stack: "水、カード、少額現金、モバイルバッテリー", fold: "Grand Canyon疲れを無視しない。" },
