const tripDays = {
  ...
  "2026-06-26": { label: "6/26 Free Tournament", note: "昼は回復優先。元気なら19:00からフリートーナメント参加受付。", date: "6/26", dow: "Fri", nextDate: "Fri 6/26", nextTitle: "Free Tournament", tag: "FREEROLL", visual: "assets/wsop-poker-table.jpg", visualLabel: "FREE", hand: "回復日 / フリートーナメント", time: "19:00 registration", seat: "WSOP会場", stack: "パスポート、スマホ、カード、水、上着", fold: "Grand Canyon疲れが強ければ見送る。受付前に食事と水分。" },
  ...
  "2026-06-28": { label: "6/28 Return Flight", note: "02:35 LAS発、6/29 06:30成田着。6/27夜から空港移動優先。", date: "6/28", dow: "Sun", nextDate: "Sun 6/28", nextTitle: "LAS -> NRT", tag: "RETURN", visual: "assets/las-vegas-airport-checkin.jpg", visualLabel: "FLIGHT", hand: "帰国便", time: "02:35 LAS / 06:30 NRT +1", seat: "LAS / ツアー最終案内優先", stack: "パスポート、スマホ、充電、液体/重量確認", fold: "6/27深夜帯の集合を最優先。Sphere後の寄り道を増やさない。" },
};
